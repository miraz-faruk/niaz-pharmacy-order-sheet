...
const Beximco = () => {
    ...
    const items = [
        ...
        { name: 'Gastalfet Suspension 200 ml' },
        { name: 'Gastalfet Suspension 400 ml' },
        ...
        { name: 'Neurocare Tab' },
        { name: 'Nevalto Tab 5/80 mg' },
        { name: 'Nitrosol Spray' },
        { name: 'Nitrosol SR Tab 2.6 mg' },
        { name: 'Nightus Tab 3 mg' },
        ...
        { name: 'Vivanta Tab 50 mg' },
        { name: 'Vivanta Tab 100 mg' },
        { name: 'Vivis Cap' },
        { name: 'Vivori Tab 50 mg' },
        { name: 'Vivori Tab 200 mg' },
        { name: 'Voligel Gel' },
