...
const Beximco = () => {
    ...
    const items = [
        ...
        { name: 'Atova EZ Tab 10 mg' },
        { name: 'Atova EZ Tab 20 mg' },
        ...
        { name: 'Bextram Gold Tab 15 tablet' },
        { name: 'Bextram Gold Tab 30 Tab' },
        ...
        { name: 'Empalina Tab 10 mg' },
        { name: 'Empalina Tab 25 mg' },
        ...
        { name: 'Neosten VT Vaginal Tab 200 mg' },
        ...
        { name: 'Telma Plus Tab 12.5 mg' },
        { name: 'Telmacal Tab 40 mg' },
        { name: 'Telmacal Tab 80 mg' },
        ...
        { name: 'Tyclav Tab 875 mg' },
        { name: 'Tyclav Tab 250 mg' },
        { name: 'Tyclav Tab 500 mg' },
