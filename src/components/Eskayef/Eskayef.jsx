...
const Eskayef = () => {
    ...
    const cardiacItems = [
        ...
        { name: 'Emazid M Tab 12.5 mg' },
        { name: 'Emazid M Tab 5 mg' },
        ...
        { name: 'Ligazid M Tab 500 mg' },
        { name: 'Ligazid M Tab 850 mg' },
        { name: 'Ligazid M Tab 1000 mg' },
    ...
    const generalItems = [
        ...
        { name: 'Alben-DS Chewable Tab 400 mg' },
        { name: 'Amboten Syp' },
        { name: 'Augment Tab 250 mg' },
        { name: 'Augment Tab 500 mg' },
        { name: 'Augment Tab 875 mg' },
        { name: 'Biltin Tab 20 mg' },
        { name: 'Biltin Oral Solution 12.5 mg' },
        ...
        { name: 'Lulizol Cream 1% 10 gm' },
        { name: 'Lulizol Cream 1% 20 gm' },
        { name: 'Lulizol Lotion 1% 50 gm' },
        { name: 'Lumona Tab 10 mg' },
        { name: 'Lumona FT Flash Tab 4 mg' },
        { name: 'Lumona FT Flash Tab 5 mg' },
        { name: 'Mig Tab 2.5 mg' },
        { name: 'Mig Tab 5 mg' },
        { name: 'Mig Tab 10 mg' },
        ...
        { name: 'Topibet CL Ointment' },
        { name: 'Topiclo S Ointment' },
        { name: 'Toti Tab 1 mg' },
        { name: 'Toti Syp' },
        { name: 'Trioclav Tab' },
        { name: 'Tufnil Tab 200 mg' },
        { name: 'Tulac Oral Solution' },
        { name: 'Tuscof Syp' },
        { name: 'Urokit Tab 1080 mg' },
        { name: 'Urokit Plus Oral Solution' },
