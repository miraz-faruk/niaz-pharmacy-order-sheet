...
const Synovia = () => {
    ...
    const items = [
        ...
        { name: 'Profenid-CR Cap 200 mg' },
        { name: 'Profenid-E Tab 50 mg' },
        { name: 'Profenid-E Tab 100 mg' },
