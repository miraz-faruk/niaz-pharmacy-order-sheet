...
const Opsonin = () => {
    ...
    const generalItems = [
        ...
        { name: "Gentin Inj 20 mg" },
        { name: "Gentin Inj 80 mg" },
        { name: "Gestcare Tab" },
        { name: "Halop Tab 5 mg" }
    ].sort((a, b) => a.name.localeCompare(b.name));
